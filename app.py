...
def main():
    ...
    if choice == "Abstract":
        ...
        st.write("1. Masih perlu ditingkatkan dari segi teknik-teknik preprocessing yang digunakan agar bisa meningkatkan performa model. Seperti gridsearch untuk seleksi fitur serta teknik untuk menentukan principal component terbaik untuk bisa mengurangi terjadinya overfitting. Selain itu, outliers yang ada pada sub sampel data latih yang digunakan untuk melatih model, bisa dilakukan penanganan terlebih dahulu sebelum digunakan, seperti menggunakan metode trimmin, winsorizing dan sebagainya. Kami belum bisa menerapkan hal-hal tersebut karena keterbatasan waktu pengerjaan final projek")
        st.write("2. Penelitian ini memiliki implikasi penting dalam berbagai sektor, terutama dalam perencanaan dan pengambilan keputusan. Model prediksi curah hujan yang akurat dapat digunakan untuk mengoptimalkan penggunaan sumber daya air, mengelola pertanian, serta merencanakan aktivitas sosial ekonomi yang bergantung pada cuaca.")
        st.write("3. Meskipun model yang dikembangkan telah memberikan hasil yang memuaskan, terdapat potensi untuk pengembangan lebih lanjut. Penelitian selanjutnya dapat mencakup perbaikan pada pengolahan data, eksplorasi metode pemodelan yang lebih kompleks, serta penerapan teknik optimasi untuk meningkatkan performa prediksi.")
